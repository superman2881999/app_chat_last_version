...
class ExceptionMembers extends StatefulWidget {
  ExceptionMembers({this.groupName, this.groupId});
  final groupId;
  final groupName;
  @override
  _ExceptionMembersState createState() => _ExceptionMembersState();
}

class _ExceptionMembersState extends State<ExceptionMembers> {
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              ...
              Constants.toastAddSuccess(context,"Ngoại trừ thành công");
